...
public class GamePanel extends JPanel implements ActionListener, Serializable {
	...
	static final int GAME_UNITS = (SCREEN_WITDH * SCREEN_HEIGHT) / UNIT_SIZE; // 14,400
	...
	public void draw(Graphics g) {
		...
		g.drawString("Score: "+applesEaten, (SCREEN_WITDH - metrics.stringWidth("Score: "+applesEaten)) / 2, g.getFont().getSize());
	  } else {
		  gameOver(g);
	  }
	...
	public void gameOver(Graphics g) {
		...
		FontMetrics metrics = getFontMetrics(g.getFont());
		g.drawString("Game Over", (SCREEN_WITDH - metrics.stringWidth("Game Over")) / 2, SCREEN_HEIGHT / 2);
	}
